...
def test_broadcast_creation():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        result = workspace.broadcast(
            ...
            agent_level=10,
            category='SECURITY',
            message='This code is safe and secure.',
            related_file='test.py'
        )
        
        assert result['success'], "Broadcast should return an ID"
        
        # Retrieve broadcasts
        broadcasts = workspace.get_broadcasts()
        assert len(broadcasts) == 1, "Should have one broadcast"
        assert broadcasts[0]['agent'] == 'claude'
...
def test_contradiction_detection():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        workspace.broadcast(
            ...
            agent_level=10,
            category='SECURITY',
            message='This code is safe and has no vulnerabilities.',
            related_file='test.py'
        )
        ...
        workspace.broadcast(
            ...
            agent_level=12,
            category='SECURITY',
            message='This code is unsafe and has vulnerabilities.',
            related_file='test.py'
        )
...
def test_contradiction_pairs():
    ...
    for word1, word2 in CONTRADICTION_PAIRS[:5]:  # Test first 5 pairs
        # workspace cleared by creating new instance
...
def test_manual_conflict_flagging():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        b1 = workspace.broadcast(
            ...
            message='This approach is correct.',
            related_file={'functions': ['process_data']}
        )
        ...
        b2 = workspace.broadcast(
            ...
            agent_level=12,
            category='CODE_QUALITY',
            message='This approach is incorrect.',
            related_file={'functions': ['process_data']}
        )
